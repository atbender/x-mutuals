...
The GIF holds the minimized pill for 2 seconds, the open list for 3 seconds, the ranking action for 3 seconds, and the final ranking for 5 seconds. No developer tools, terminal, or request log appears in the recording.
